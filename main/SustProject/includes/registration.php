...
<?php require_once("../SustProject/mailinfo.php");?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="registerForm"  method="post" action="" >
                            ...
                            <div class="form-group">
                                <input type="password" id="confirm_password" name="confirmPassword" placeholder="Confirm Password" class="form-control" >
                            </div>
                            <!--<p id="warning"></p>-->
                            <div class="form-group">
                                <input type="submit" name="reg_submit" value="Registration" class="form-control btn btn-primary">
                            </div>
